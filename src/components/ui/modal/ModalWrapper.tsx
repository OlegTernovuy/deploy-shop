...
export default function ModalWrapper({ children, title, search }: IModal) {
  ...
  return (
    show && (
      <div className="fixed inset-0 bg-white overflow-y-auto h-full w-full md:max-w-[960px] md:h-min md:max-h-[760px] m-auto md:rounded-lg flex flex-col z-10 text-black divide-y divide-slate-300">
